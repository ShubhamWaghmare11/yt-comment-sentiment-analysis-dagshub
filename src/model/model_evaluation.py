...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    try:
        ...
        print('Error loading data from %s: %s', file_path, e)
        raise
...
def load_model(model_path: str):
    ...
    try:
        ...
        print('Error loading model from %s: %s', model_path, e)
        raise
...
def load_vectorizer(vectorizer_path: str) -> TfidfVectorizer:
    ...
    try:
        ...
        print('Error loading vectorizer from %s: %s', vectorizer_path, e)
        raise
...
def load_params(params_path: str) -> dict:
    ...
    try:
        ...
        print('Error loading parameters from %s: %s', params_path, e)
        raise
...
def evaluate_model(model, X_test: np.ndarray, y_test: np.ndarray):
    ...
    try:
        ...
        print('Error during model evaluation: %s', e)
        raise
...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            ...
            print(f"Failed to complete model evaluation: {e}")
            print(f"Error: {e}")
